...
function save() {
    ...
    if (fullname === '') {
        ...
        fullname = '';
        document.getElementById('name-error').innerHTML = 'Tên phải dài hơn 2 kí tự!';
    } else if (fullname.trim().length >= 50) {
        fullname = '';
        document.getElementById('name-error').innerHTML = 'Tên không được dài hơn 50 kí tự!';
    } else {
    ...
    if (mssv === '') {
        ...
        mssv = '';
        document.getElementById('mssv-error').innerHTML = 'MSSV phải bao gồm 6 chữ số!';
    } else {
